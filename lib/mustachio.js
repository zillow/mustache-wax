...
var fs = require('fs'),
    ...
    // also provides yui-base, escape modules
...
Mustachio.prototype = {
    ...
    processTemplate: function (template, root) {
        ...
        if (stat.isDirectory()) {
            ...
            precompiled = Y.Handlebars.precompile(fs.readFileSync(tmpl, 'utf8'), {
    ...
    wrapModule: function (templateName, precompiledFn) {
        ...
        return [
            ...
            '    Y.namespace("' + this.namespace + '")["' + templateName + '"] = Y.Handlebars.template(' + precompiledFn + ');\n',
